...
We can control the user interface based on three dimensional motion as input or we can combine it with another sensors as are location detection or video cameras [[8](#references)]. There are a lot of interesting interface designs made possible by device motion. It depends on us how we use them.
