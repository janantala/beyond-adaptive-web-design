...
% subsubsection touch (end)

\subsubsection*{Speech} % (fold)
\label{sub:speech}
...
% subsubsection speech (end)

\subsubsection*{Device motion} % (fold)
...
% subsubsection video_motion (end)
