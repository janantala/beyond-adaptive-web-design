...
% paragraph speech (end)

\paragraph{Device motion} % (fold)
...
% paragraph device_motion (end)

\paragraph{Video Motion} % (fold)
...
% paragraph voice_commands (end)

\paragraph{Gyroscope rotation} % (fold)
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[width=0.2\textwidth]{../images/gyroscope}
...
% paragraph gyroscope_rotation (end)

\paragraph{Video camera motion} % (fold)
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{../images/videomotion}
...
% paragraph video_camera_motion (end)
...
There are a lot of commonly used web services that produce unnecessary traffic. Elements like videos or maps are a common part of the most web sites. All of them produces many requests and the web traffic even the website user doesn't want to watch the video or browse the map. There are also native mobile application for that services with better perfomance. So what can we to do? This is a great opportunity to utilize conditional loading to serve the best experience for the right context.
